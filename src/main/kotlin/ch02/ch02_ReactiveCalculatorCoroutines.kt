...
class ReactiveCalculatorCoroutines(a: Int, b: Int) {
    private val subjectCalc: Subject<ReactiveCalculatorCoroutines> = PublishSubject.create()
...
fun main() {
    ...
    val calculator = ReactiveCalculatorCoroutines(15, 10)
